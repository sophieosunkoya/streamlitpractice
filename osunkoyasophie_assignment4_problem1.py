...
#Create while statement for validitiy of sides
while True:
...
#imprt random
import random
#set variables equals to 0 so they can keep increasing
total=0
double=0
high=0
highLow=0
...
sum1=0
sum2=0
#create while statement to run the variables and create conditions for the types of rolls
while True:
    count+=1
    ...
    if  die1+die2==die_sides:
        ...
        sumValue+=1
    print()
#create variables to calculate the percent of each type of roll
...
#print the percent calculated above alongside strings
...
print("Average roll for die #1:", "{:.2f}".format(sum1/totalrolls))
print("Average roll for die #2:", "{:.2f}".format(sum2/totalrolls))
